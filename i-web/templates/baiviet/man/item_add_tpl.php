        ...
        <div class="mtop0">
                ...
                <div class="widget mtop0">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" name="data[min]" data-validation="required" data-validation-error-msg="Khoảng giá không được bỏ trống" title="Nhập giá bán" id="min" class="conso tipS"
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" name="data[max]" data-validation="required" data-validation-error-msg="Khoảng giá không được bỏ trống" title="Nhập giá bán" id="max" class="conso tipS"
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" data-validation="required" data-validation-error-msg="Link không được để trống" name="data[link_facebook]" title="Nhập link" id="link_facebook"
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" data-validation="required" data-validation-error-msg="Link không được để trống" name="data[link_zalo]" title="Nhập link" id="link_zalo"

                                class="tipS" value="<?=@$item['link_zalo']?>" />
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" data-validation="required" data-validation-error-msg="Link không được để trống" name="data[link_twitter]" title="Nhập link" id="link_twitter"
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" data-validation="required" data-validation-error-msg="Link không được để trống" name="data[link_instagram]" title="Nhập link" id="link_instagram"
                    ...
                    <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                        ...
                        <div class="ck_editor">
                            ...
                            <textarea title="Nhập từ khóa [<?=$v?>]. " data-height="400" id="tukhoa_<?=$k?>"

                                <?=($table['tukhoa-ckeditor']==true) ? 'class="ck_editors"':'rows="8"' ?>

                                name="data[tukhoa_<?=$k?>]"><?=@$item['tukhoa_'.$k]?></textarea>
            ...
            <div class="<?=($table['full']==true) ? 'oneOne':'colRight' ?>">
                ...
                <div class="widget mtop0">
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <select name="data[id_tacgia]" id="id_tacgia" class="main_select">
                                    ...
                                    <option <?php if($item["id_tacgia"]==$value["id"]){echo "selected";}else{'';} ?> value="<?=$value["id"]?>"><?=$value["ten"]?></option>
                            ...
                            <div class="formRight">
                                ...
                                <select name="data[index_robots]" id="index_robots" class="main_select">
                                    ...
                                    <?php foreach($robots_array as $key => $value){ ?>
                                        ...
                                        <option <?php if($item["index_robots"]==$value){echo "selected";}else{'';} ?> value="<?=$value?>"><?=$value?></option>
                    ...
                    <?php if($table['huong']==true){
                        
                        $row_huong = $db->rawQuery("select id,ten_$lang as ten from #_baiviet where hienthi=1 and type=? order by stt asc",array('huong'));
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <select name="data[id_huong]" id="id_huong" class="main_select">

                                    <option value="">Chọn hướng</option>

                                    <?php foreach($row_huong as $key => $value){ ?>

                                    <option <?php if($item["id_huong"]==$value["id"]){echo "selected";}else{'';} ?> value="<?=$value["id"]?>"><?=$value["ten"]?></option>
                    ...
                    <?php if($table['loaidat']==true){
                        
                        $row_loaidat = $db->rawQuery("select id,ten_$lang as ten from #_baiviet where hienthi=1 and type=? order by stt asc",array('loai-dat'));
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <select name="data[loaidat]" id="loaidat" class="main_select">

                                    <option value="">Chọn loại đất</option>

                                    <?php foreach($row_loaidat as $key => $value){ ?>

                                    <option <?php if($item["loaidat"]==$value["id"]){echo "selected";}else{'';} ?> value="<?=$value["id"]?>"><?=$value["ten"]?></option>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" name="data[xuatxu]" title="Nhập vị trí" id="xuatxu"
                    ...
                    <?php if($GLOBAL[$com][$type]['dientich']==true){?>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <input type="text" name="data[dientich]"  title="Nhập diện tích" id="dientich"

                                    class="tipS conso" value="<?=@$item['dientich']?>" style="font-size: 12px;padding: 7px 6px;background: white;border: 1px solid #DDD;width: 100%;font-family: Arial, Helvetica, sans-serif;color: #656565;box-sizing: border-box;"/>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <select name="data[id_loai]" id="id_loai" class="main_select">
                                    ...
                                    <option value="1" <?=(@$item['id_loai']==1) ? 'selected':''?>>Đang mở bán

                                    </option>

                                    <option value="2" <?=(@$item['id_loai']==2) ? 'selected':''?>>Đã bán
