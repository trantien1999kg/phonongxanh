<nav class="sidebar-nav">
    ...
    <ul class="metismenu" id="menu1">
        ...
        <?php  /* <li class="<?=($com=='baiviet' && ($_GET['type']=='tac-gia')) ? "active" :""?>">
        ...
        <li class="<?=($com=='baiviet' && ($_GET['type']=='vi-sao')) ? "active" :""?>">
            <a class="has-arrow" href="#"
                aria-expanded=" <?=($com=='baiviet' && ($_GET['type']=='vi-sao')) ? "true" :"false"?>">
                <span>
                    <i class="nav-icon text-sm fal fa-boxes"></i>Quản lý vì sao
                </span>

            </a>

            <ul aria-expanded="<?=($com=='baiviet' && ($_GET['type']=='vi-sao')) ? "true" :"false"?>"
                class="collapse <?=($com=='baiviet' && ($_GET['type']=='vi-sao')) ? "in" :""?>"
                <?=($com=='baiviet' && ($_GET['type']=='vi-sao')) ? "" :"style='height: 0px;'"?>>

                <li class="<?=($com=='baiviet' && $act=='man' && 'vi-sao'==$_GET['type']) ? "this" :""?>">

                    <a href="index.php?com=baiviet&act=man&type=vi-sao&page=1">Danh sách</a>
        ...
        <li class="<?=($com=='baiviet' && ($_GET['type']=='feedback')) ? "active" :""?>">
            ...
            <ul aria-expanded="<?=($com=='baiviet' && ($_GET['type']=='feedback')) ? "true" :"false"?>"
                class="collapse <?=($com=='baiviet' && ($_GET['type']=='feedback')) ? "in" :""?>"
                <?=($com=='baiviet' && ($_GET['type']=='feedback')) ? "" :"style='height: 0px;'"?>>

                <li class="<?=($com=='baiviet' && $act=='man' && 'feedback'==$_GET['type']) ? "this" :""?>">

                    <a href="index.php?com=baiviet&act=man&type=feedback&page=1">Danh sách</a>
        ...
        <li <?=($com=='photo' || $com=='video') ? ' class="active"' : '' ?>>
            ...
            <ul aria-expanded="<?=($com=='photo' || $com=='video') ? 'true' : 'false' ?>"
                ...
                <li <?=($com=='photo' && $_GET['type']=='intro-top') ? ' class="this"' : '' ?>><a
                        href="index.php?com=photo&act=man&type=intro-top&page=1" title="">Hình ảnh giới thiệu</a>

                </li>
                <li <?=($com=='photo' && $_GET['type']=='img-map') ? ' class="this"' : '' ?>><a
                        href="index.php?com=photo&act=man&type=img-map&page=1" title="">Hình ảnh dưới bản đồ</a>
        ...
        <li class="<?=(($com=='contact' || $com=='booking' || $com=='newsletter') && $act=='man') ? "active" :""?>">
            ...
            <ul aria-expanded="<?=(($com=='contact' || $com=='booking' || $com=='newsletter') && $act=='man') ? "true" :"false"?>"
                ...
                <li <?php if($com=='booking' && $act=='man' && $_GET["type"]=='yeu-cau') echo ' class="this"' ?>><a
                        href="index.php?com=booking&act=man&type=yeu-cau" title="">Yêu cầu tìm đất</a></li>
