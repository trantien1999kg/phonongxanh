                        ...
                        <div class="row10 d-flex flex-wrap">
                            ...
                            <div class="item10 col-6 w-100-m">
                                ...
                                <div class="img-top">
                                    ...
                                    <a href="thumbs/912x531x1/<?=_upload_baiviet_l.$row_detail['photo']?>"
                                        class="MagicZoom" id="Zoom-1"
                                        data-options="variableZoom: true;expand: on; hint: always; ">

                                        <img class="col-12"
                                            src="thumbs/912x531x1/<?=_upload_baiviet_l.$row_detail['photo']?>"
                                    ...
                                    <div class="product-detail-slider owl-carousel owl-theme owl-carousel-loop in-home"
                                        ...
                                        <div class="items mb20">
                                            <div class="img"><a data-zoom-id="Zoom-1"
                                                    ...
                                                    data-image="thumbs/912x531x1/<?=_upload_baiviet_l.$row_detail['photo']?>"><img
                                        ...
                                        <div class="items mb20">
                                            <div class="img"><a data-zoom-id="Zoom-1"
                                                    ...
                                                    data-image="thumbs/912x531x1/<?=_upload_baiviet_l.$v['photo']?>"><img
                                                        loading="lazy"
                                                        src="thumbs/912x531x1/<?=_upload_baiviet_l.$v['photo']?>"
                                                        alt="<?=$row_detail['ten_'.$lang]?>"></a></div>
                                        </div>
                                            ...
                                            <ul>
                                                        ...
                                                        <div class="item10 col-12">
                                                            <div class="wrapper-product__detail-content">
                                                                <span class="wrapper-product__detail-content-price"><i
                                                                    ...
                                                                    <strong>Giá:</strong>
                                                                    <b><?=($row_detail["giaban"]!=0)? $func->FormatBDSMoney($row_detail["giaban"]):'Liên hệ';?></b></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li>
                                                    <div class="row10 d-flex">
                                                        <div class="item10 col-12">
                                                            <div class="wrapper-product__detail-content">
                                                                <span><i class="fa-solid fa-house-day mr10"></i>
                                                                    <strong>Loại đất:</strong>
                                                                    <b><?=$ld_detail["ten"]?></b></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
