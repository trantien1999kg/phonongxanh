    ...
    <div class="maxSlider">
        ...
        <div class="box-slider">
            ...
            <div class="slider-left1">
                ...
                <div id="jssor_1"
                    style="position:relative;margin:0 auto;top:0px;left:0px;width:1440px;height:400px;overflow:hidden;visibility:hidden;">

                    <div data-u="slides"
                        style="cursor:default;position:relative;top:0px;left:0px;width:1440px;height:400px;overflow:hidden;">

                        <?php foreach ($slider as $k => $v){ $stt++; ?>

                        <div data-idle="3000">

                            <img width="1440" height="400" class="ratio-img__content img-scale" data-u="image"
                                src="./assets/images/loading_image.svg" data-src="<?=_upload_hinhanh_l.$v['photo']?>"
                                alt="<?=$v['ten_'.$lang]?>" <?=$func->errorImg()?> />

                            <?php /*
                            <div class="boxslider_details pb10">

                                <div class="scrolltext_SLIDER">
                                    <div class="scrolltext"><?= $row_setting['scrolltext1_vi']?></div>
                                    <div class="scrolltext"><?= $row_setting['scrolltext2_vi']?></div>
                                </div>

                                <div class="boxslider_details__des typewrite mb30 mt5" data-period="1000"
                                    data-type='[ "<?=$v["mota"]?>" ]'>

                                    <span class="boxslider_details__des-content typewrite_wrap"><?= $v["mota"] ?></span>

                                </div>

                                    <a href="<?=$v['link']?>" class="link_slider  mt20" rel="nofollow" target="_blank">XEM THÊM</a>
