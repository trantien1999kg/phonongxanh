        ...
        <ul>
            ...
            */ ?>
            ...
            <li>
                ...
                <a class="transition <?php if($com=='dich-vu') echo 'active'; ?>" href="dich-vu" title="DỊCH VỤ">DỊCH
                    VỤ</a>
            </li>
            ...
            <li>
                ...
                <a class="transition <?php if($com=='ky-gui') echo 'active'; ?>" href="ky-gui" title="Ký gửi">Ký
            gửi</a>
            ...
            */ ?>
            ...
            <li>
                <a class="transition <?php if($com=='tin-tuc') echo 'active'; ?>" href="tin-tuc"
                    title="KỸ THUẬT CHĂM SÓC">KỸ THUẬT CHĂM SÓC</a>
            </li>

            <li>

                <a class="transition <?php if($com=='lien-he') echo 'active'; ?>" href="lien-he" title="LIEN HỆ">LIEN
                    HỆ</a>
