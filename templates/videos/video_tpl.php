                ...
                <div class="row10 d-flex flex-wrap">
                    ...
                    <div class="item10 col-3 w-50-m mb20">
                        <div class="show-youtube list-youtube p-relative cs-pointer"
                            data-links="<?=$func->getYoutube($tintuc[$i]['links'])?>">
                            <div class="item-video1">
                                <a data-fancybox href="<?=$tintuc[$i]['links']?>" title="<?=$tintuc[$i]['ten_'.$lang]?>">
                                    <img class="img-block" src="https://img.youtube.com/vi/<?=$func->getYoutube($tintuc[$i]['links'])?>/mqdefault.jpg">
