<?php 
	...
	$GLOBAL['baiviet'][$nametype]['img-width'] = 222;

	$GLOBAL['baiviet'][$nametype]['img-height'] = 118;
...
$GLOBAL['baiviet'][$nametype]['cat'] = true;
	...
	$GLOBAL['info'][$nametype]['img'] = false;
	...
	$GLOBAL['photo'][$nametype]['title_main'] = 'Hình ảnh dưới bản đồ';
	...
	$GLOBAL['bannerqc'][$nametype]['img_type']='.swf|.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF|.webp';
		...
		$GLOBAL['bannerqc'][$nametype]['title_main'] = 'Banner trang chủ';
	
		$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý Banner trang chủ';
	...
	$nametype='icon_sanphamnoibat';

	$GLOBAL['bannerqc'][$nametype]['title_main'] = 'Icon sản phẩm nổi bật';

	$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý Icon sản phẩm nổi bật';
	...
	$nametype='icon_dichvu';

	$GLOBAL['bannerqc'][$nametype]['title_main'] = 'Icon dịch vụ ưa thích';

	$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý Icon dịch vụ ưa thích';
	...
	$GLOBAL['bannerqc'][$nametype]['title_main'] = 'Background danh mục';

	$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý Background danh mục';

	$GLOBAL['bannerqc'][$nametype]['full'] = false;

	$GLOBAL['bannerqc'][$nametype]['img'] = true;

	$GLOBAL['bannerqc'][$nametype]['img-width'] = 422;

	$GLOBAL['bannerqc'][$nametype]['img-height'] = 571;
	...
	$nametype='ha-gioithieu';

	$GLOBAL['bannerqc'][$nametype]['title_main'] = 'Hình ảnh giới thiệu';

	$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý Hình ảnh giới thiệu';

	$GLOBAL['bannerqc'][$nametype]['full'] = false;

	$GLOBAL['bannerqc'][$nametype]['img'] = true;

	$GLOBAL['bannerqc'][$nametype]['img-width'] = 432;

	$GLOBAL['bannerqc'][$nametype]['img-height'] = 432;
	...
	$GLOBAL['bannerqc'][$nametype]['title_main'] = 'Background giới thiệu mobile';

	$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý Background giới thiệu mobile';
	...
	$GLOBAL['booking'][$nametype]['dientich'] = true;

	$GLOBAL['booking'][$nametype]['taichinh'] = true;
